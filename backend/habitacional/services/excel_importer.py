...
def parse_integrantes(valor):
    ...
    patrones = [
        r"(?:total|integrantes?|miembros?|personas?|familiares?|grupofamiliar|grupofam|grofam|gpofam|grpfam|gpfam|gfam|nucleofamiliar|nucleohogar|hogar|gf)(\d{1,2})",
        r"(\d{1,2})(?:integrantes?|miembros?|personas?|familiares?|grupofamiliar|grupofam|grofam|gpofam|grpfam|gpfam|gfam|nucleofamiliar|nucleohogar|hogar|gf)",
    ]
